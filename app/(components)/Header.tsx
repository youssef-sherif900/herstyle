  ...
  return (
    <div>
      ...
      <header className="bg-white text-purple p-4 lg:px-24 flex justify-between items-center">
        ...
        <Link href="/">
        <Image className="" src="/LOGO1-02.png" alt="logo" height={60} width={60} />
        </Link>
      </header>
      {/* Navigation */}
      <nav className="w-full flex items-center bg-purple text-white text-xs lg:text-base text-center lg:px-24 lg:py-2 p-4">
        <Login />
